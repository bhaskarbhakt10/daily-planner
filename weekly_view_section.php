...
$(document).ready(function() {
    const $viewSection = $('.weekly-view-section');

    $viewSection.find('input[type="text"]').prop('readonly', true);
    $viewSection.find('select, textarea').prop('disabled', true);
    $viewSection.find('button').prop('disabled', true);
});
</script>
